...
class DefaultTeamValues:
    winrate: float
    gold_per_minute_or_gold_lead: float
    ...
    dragons_per_game_or_match:float
...
class Team:
    def __init__(self,players:list[Player],winrate:float,gold_per_minute:float,gold_differential_per_minute:float, gold_differential_at_15_min:float, cspm:float, cs_differential_at_15_min:float,tower_differential_at_15_min:float, avg_tower_difference:float, first_tower:float, damage_per_minute:float, first_blood:float,kills_per_game:float,deaths_per_game:float,avg_kd:float,plates_per_game:float,plates_per_game_per_side:float,dragons_per_game:float,dragons_at_15_min:float,void_grubs_per_game:float,atakhan_per_game:float,herald_per_game:float,nashor_per_game:float,feats_of_strength:float,vision_score_per_minute:float):
        ...
        self.default_team_values = DefaultTeamValues(winrate,gold_per_minute,gold_differential_per_minute,gold_differential_at_15_min,cspm,cs_differential_at_15_min,tower_differential_at_15_min,avg_tower_difference,first_tower,damage_per_minute,first_blood,kills_per_game,deaths_per_game,avg_kd,plates_per_game,plates_per_game_per_side,dragons_per_game,dragons_at_15_min,void_grubs_per_game,atakhan_per_game,herald_per_game,nashor_per_game,feats_of_strength,vision_score_per_minute)
    ...
    def evaluate_team_match_and_tournament(self,tournament_name:str, tournament_kills:float,gold_lead:float,match_players:list[Player]):
        match_coefficient = 1
